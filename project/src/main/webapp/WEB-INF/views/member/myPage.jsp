...
.form__input-block{margin-top: 10px}
.input_label{width:240px; display: flex; justify-content: space-between;}
.mod_btn{background-color: #ff7867; color: white; border: 0; border-radius: 15%}
</style>
</head>
	...
	<div class="signup__main" >
		<form class="signup__form" action="${contextPath }/member/regist">
			...
			<div class="form__input-block">
				<div class="input_label"><label for="name" class="form__label">이름</label></div>
				<div class="ac-input-with-item--large ">
					<input id="name" type="text" value="${mem.name }" name="name" disabled/> 
				</div>
			</div>
			<div class="form__input-block">
			<div class="input_label"><label for="password" class="form__label">비밀번호</label><button type="button" class="mod_btn">수정</button></div>
			...
			<div class="form__input-block">
			<div class="input_label"><label for="email" class="form__label">이메일</label><button type="button" class="mod_btn">수정</button></div>
			...
			<div class="form__input-block">
				...
				<div class="ac-input-with-item--large ">
					<input id="birthday" value="${mem.birthday }" type="text" name="birthday" disabled/>
				</div>
			</div>
			<div class="form__input-block">
			<div class="input_label"><label for="address" class="form__label">주소</label><button type="button" class="mod_btn">수정</button></div>
				
				<div class="ac-input-with-item--large">
					<input id="address" value="${mem.address }" type="text" name="address" disabled/>
				</div>
			</div>
			
			<div class="form__input-block">
			<div class="input_label"><label for="phone" class="form__label">전화번호</label><button type="button" class="mod_btn">수정</button></div>
				
				<div class="ac-input-with-item--large ">
					<input id="phone" value="${mem.phone }"  type="text" name="phone" disabled/>
				</div>
			</div>						
			<button class="ac-button is-lg is-solid is-primary e-sign-up-button form__button" >수정하기</button>
		</form>
	</div>
	</section>
