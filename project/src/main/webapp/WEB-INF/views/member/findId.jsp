...
<session class="find-password-root e-find-password-root">
	<div class="bootstrap-components find-password__text">
		...
		<form name="frm" action="${contextPath }/member/findId">
			<input class="form-control" id="email" type="email" placeholder="example@gmail.com" id="email"/>
