								...
								<div class="card course course_card_item"
									...
									<a class="course_card_front e_course_click" href="${contextPath }/lecture/lecture_id?lecture_id=${lacture_id}">
										...
										<div class="card-content">
											...
											<div class="instructor">${lecture.teacher_id }</div>
											<!-- 별점 -->
											<div class="rating">
												...
												<span class="review_cnt">총 리뷰수</span>
											</div>
											<div class="price">${lecture.price} </div>
											<div class="tags">
												<span class="tag "
													style="background-color: hsl(321, 63%, 90%)">+수강생 수</span>
											</div>
										</div>
