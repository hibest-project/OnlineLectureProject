				...
				<div class="community-post-info">
					...
					<div class="community-post-info__header">
						<div class="header__title">
							...
							<ul class="dropdown-menu dropdown-menu-lg-end show"
								aria-labelledby=""
								style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(-49.1228px, 34.2105px);"
								data-popper-placement="bottom-end">
								<li>
									<button class="dropdown-item  post__edit-btn e-edit"
										type="button">
										<span><i class="fa-regular fa-pen-to-square"></i>수정</span>
									</button>
								</li>
								<li>
									<button class="dropdown-item  post__remove-btn e-remove"
										type="button">
						...
						<div class="header__sub-title">
							...
							<div class="header__sub-title__content">
								<div class="content-date">
									<span class="sub-title__created-at">${vb.date }
									
										<a href="">수정</a>
										
										<!-- 게시글 삭제 -->
										<a href="${path}/customercenter/inquiryremove?inquiryid=${vb.inquiryid}">삭제</a>
