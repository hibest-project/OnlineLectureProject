				...
				<div class="navbar-left">
						...
						<ul class="navbar-dropdown is-boxed">
							<c:forEach var="categorie" items="${clist }">
								<li><a class="navbar-item"
									href="${contextPath }/categorie/categorieNum?categorieNum=${categorie.categorie_num }">${categorie.cname }</a></li>
							</c:forEach>
						</ul>
					</div>
					...
					<div class="has-dropdown is-hoverable navbar-item  icon_drop_menu">
						...
						<div class="navbar-dropdown is-boxed is-right">
							...
							<a class="navbar-item " href="#"> <span class="icon"><i
									class="fal fa-comment-alt-edit"></i></span> <span class="name">질문
									&amp; 답변</span>

							</a> <a class="navbar-item " href="#"> <span class="icon"><i
									class="fal fa-comment-alt-dots"></i></span> <span class="name">자유주제</span>

							</a> <a class="navbar-item " href="#"> <span class="icon"><i
									class="fal fa-book-open"></i></span> <span class="name">스터디</span>
					...
					<div class="has-dropdown is-hoverable navbar-item  icon_drop_menu">
						...
						<div class="navbar-dropdown is-boxed is-right">
							...
							<a class="navbar-item " href="#"> <span class="icon"><i
									class="fal fa-star"></i></span> <span class="name">수강평</span>

							</a> <a class="navbar-item " href="#"> <span class="icon"><i
									class="fal fa-lightbulb-on"></i></span> <span class="name">멘토링
									후기</span>
									...
									class="fal fa-comment-smile"></i></span> <span class="name">강의·기능
									요청</span>
				...
				<div class="navbar-right">
					...
					<div class="navbar-item buttons">
						...
						<c:if test="${!empty auth}">
							...
							<a role="button" class="button space-inset-4 signin"
								href="${contextPath}/mypage/viewmypage ">마이페이지</a>
							<a class="e-signup button space-inset-4 is-primary "
