...
<body id="inflearn" class="main_page is_logged_out is-student-user">
   <header id="header"> 
      ...
      <c:if test="${empty auth}">
          <a role="button" class="button space-inset-4 text is-5 signin" href="${pageContext.request.contextPath }/member/loginForm">로그인</a>
          <a class="e-signup button space-inset-4 text is-5 is-primary " href="${pageContext.request.contextPath }/member/registForm">회원가입</a>
          </c:if>
          <c:if test="${!empty auth}">
          <span>${auth.name}님, 즐 하루!!!</span>
           <a role="button" class="button space-inset-4 text is-5 signin" href="${pageContext.request.contextPath }/member/myPage">마이페이지</a>
          <a class="e-signup button space-inset-4 text is-5 is-primary " href="${pageContext.request.contextPath }/member/logout">로그아웃</a>
         ...
         <div class="container desktop_container">
          ...
          <c:if test="${!empty auth}">
          <span>${auth.name}님, 즐 하루!!!</span>
           <a role="button" class="button space-inset-4 signin" href="${pageContext.request.contextPath }/member/myPage">마이페이지</a>
